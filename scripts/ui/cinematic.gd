...
@export var next_scene := "res://scenes/rooms/room_road.tscn"

const INTRO_AUDIO := preload("res://assets/audio/ambience/cinematica_intro.ogg")
...
func go_to_next_scene() -> void:
	...
	# SceneRouter is an autoload: survives the scene swap and emits scene_changed.
